...
int sc_main(int argc, char *argv[])
{
	...
	sc_signal<sc_int<32>> adderMux, EX_MEMmux, muxPc, pcIF_ID, pcIm, imIF_ID, IF_ID_ID_EX, IF_ID_FileRegister1, pcAdder, tbAdder /*tbAdder siempre escribe 1 sobre el puerto*/;

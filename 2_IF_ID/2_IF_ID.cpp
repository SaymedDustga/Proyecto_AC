...
void IF_ID::operation()
{
	...
	if (instruction == 0 || instruction == 3 or instruction == 6 or instruction == 7 or instruction == 12 or instruction == 13 or instruction == 8 or instruction == 9 or instruction == 14 or instruction == 15)
	{
	...
	if (instruction == 0 || instruction == 14 || instruction == 15)
	{

...
int sc_main(int argc, char *argv[])
{
	...
	*/	
	sc_signal<sc_int<32>> exMem_muxPC, muxPc_pc;
...
//	id_ex.Imm_genIn(ImmGen_idEx); aqui sigue el problema de gem XD
	...
	sc_signal<bool> Mem_MemWrite2, Mem_MemRead2, Mem_Branch2;
	...
	ex_mem.alu_to_brachOut(alu_exMem_1bit);

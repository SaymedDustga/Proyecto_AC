...
public:
	sc_in_clk clk;								// Reloj
	sc_in<sc_int<32>> aIn, bIn;				// Valores A y B leídos de los registros en las direcciones raOut y rbOut
	sc_out<sc_uint<5>> raOut, rbOut, rwOut;		// Direcciones de registros: rwOut para escribir, raOut y rbOut para leer
	sc_out<sc_int<32>> wOut;					// Valor de escritura para el registro
